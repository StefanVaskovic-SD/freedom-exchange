...
export const PROVIDERS: ProviderConfig[] = [
  ...
  },
  {
    id: 'just-group',
    name: 'Just Group',
    iconUrl: '/just-group-icon.png',
    logoUrl: '/just-group-logo.png',
    cardBgUrl: '/just-group-logo.png',
  },
  {
    id: 'rothesay',
    name: 'Rothesay',
    ...
    cardBgUrl: '/rothesay-logo.png',
  },
  {
    id: 'nestle-pensions',
    name: 'Nestlé Pensions',
    iconUrl: '/nestle-pensions-icon.png',
    logoUrl: '/nestle-pensions-logo.png',
    cardBgUrl: '/nestle-pensions-logo.png',
  },
  {
    id: 'amey',
    name: 'Amey',
    ...
    cardBgUrl: '/amey-logo.png',
  },
  {
    id: 'brightwell',
    name: 'Brightwell',
    iconUrl: '/brightwell-icon.png',
    logoUrl: '/brightwell-logo.png',
    cardBgUrl: '/brightwell-logo.png',
  },
  {
    id: 'btps',
    name: 'BTPS',
    iconUrl: '/btps-icon.png',
    logoUrl: '/btps-logo.png',
    cardBgUrl: '/btps-logo.png',
  },
  {
    id: 'zurich',
    name: 'Zurich',
    iconUrl: '/zurich-icon.png',
    logoUrl: '/zurich-logo.png',
    cardBgUrl: '/zurich-logo.png',
  },
  {
    id: 'first-pensions',
    name: 'First Pensions',
    iconUrl: '/first-pensions-icon.png',
    logoUrl: '/first-pensions-logo.png',
    cardBgUrl: '/first-pensions-logo.png',
  },
  {
    id: 'bp',
    name: 'bp',
  ...
  },
  {
    ...
    cardBgUrl: '/ngukps-logo.png',
  },
  {
    id: 'trafalgar-house',
    name: 'Trafalgar House',
    iconUrl: '/trafalgar-house-icon.png',
    logoUrl: '/trafalgar-house-logo.png',
    cardBgUrl: '/trafalgar-house-logo.png',
  },
  {
    id: 'railpen',
    name: 'Railpen',
    ...
    cardBgUrl: '/railpen-logo.png',
  },
  {
    id: 'gallagher',
    name: 'Gallagher',
    iconUrl: '/gallagher-icon.png',
    logoUrl: '/gallagher-logo.png',
    cardBgUrl: '/gallagher-logo.png',
  },
  {
    id: 'spence',
    name: 'Spence',
    iconUrl: '/spence-icon.png',
    logoUrl: '/spence-logo.png',
    cardBgUrl: '/spence-logo.png',
  },
  {
    id: 'lcp',
    name: 'LCP',
    iconUrl: '/lcp-icon.png',
    logoUrl: '/lcp-logo.png',
    cardBgUrl: '/lcp-logo.png',
  },
  {
    id: 'first-actuarial',
    name: 'First Actuarial',
    iconUrl: '/first-actuarial-icon.png',
    logoUrl: '/first-actuarial-logo.png',
    cardBgUrl: '/first-actuarial-logo.png',
  },
  {
    id: 'hymans-robertson',
    name: 'Hymans Robertson',
    iconUrl: '/hymans-robertson-icon.png',
    logoUrl: '/hymans-robertson-logo.png',
    cardBgUrl: '/hymans-robertson-logo.png',
  },
  {
    id: 'isio',
    name: 'isio',
    ...
    cardBgUrl: '/isio-logo.png',
  },
  {
    id: 'broadstone',
    name: 'Broadstone',
    iconUrl: '/broadstone-icon.png',
    logoUrl: '/broadstone-logo.png',
    cardBgUrl: '/broadstone-logo.png',
  },
  {
    id: 'barnett-waddingham',
    name: 'Barnett Waddingham',
    iconUrl: '/barnett-waddingham-icon.png',
    logoUrl: '/barnett-waddingham-logo.png',
    cardBgUrl: '/barnett-waddingham-logo.png',
  },
  {
    id: 'mufg',
    name: 'MUFG',
    iconUrl: '/mufg-icon.png',
    logoUrl: '/mufg-logo.png',
    cardBgUrl: '/mufg-logo.png',
  },
  {
    id: 'wtw',
    name: 'WTW',
    iconUrl: '/wtw-icon.png',
    logoUrl: '/wtw-logo.png',
    cardBgUrl: '/wtw-logo.png',
  },
  {
    id: 'capita',
    name: 'Capita',
    iconUrl: '/capita-icon.png',
    logoUrl: '/capita-logo.png',
    cardBgUrl: '/capita-logo.png',
  },
  {
    id: 'xps-group',
    name: 'XPS Group',
    iconUrl: '/xps-group-icon.png',
    logoUrl: '/xps-group-logo.png',
    cardBgUrl: '/xps-group-logo.png',
  },
  {
    id: 'ppf',
    name: 'PPF',
  ...
  },
  {
    ...
    cardBgUrl: '/tpt-logo.png',
  },
  {
    id: 'quai-digital',
    name: 'Quai Digital',
    iconUrl: '/quai-digital-icon.png',
    logoUrl: '/quai-digital-logo.png',
    cardBgUrl: '/quai-digital-logo.png',
  },
  {
    id: 'peoples-pension',
    name: "People's Pension",
    iconUrl: '/peoples-pension-icon.png',
    logoUrl: '/peoples-pension-logo.png',
    cardBgUrl: '/peoples-pension-logo.png',
  },
];
