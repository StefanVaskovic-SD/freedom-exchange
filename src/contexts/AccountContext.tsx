...
export const PROVIDERS: ProviderConfig[] = [
  ...
  },
  {
    id: 'quai-digital',
    name: 'Quai Digital',
    iconUrl: '/quai_digital-icon.png',
    logoUrl: '/quai_digital-logo.svg',
    cardBgUrl: '/quai_digital-card.png',
  },
  {
    id: 'peoples-pension',
    name: "People's Pension",
    iconUrl: '/peoples_pension-icon.png',
    logoUrl: '/peoples_pension-logo.svg',
    cardBgUrl: '/peoples_pension-card.png',
  },
];
