...
import { useAccounts, AccountType, CURRENCY_INFO, WALLET_CURRENCIES, convertCurrency, getExchangeRate } from "@/contexts/AccountContext";
...
const AccountDetail: React.FC = () => {
	...
	// Sync fromCurrency when tab changes
	useEffect(() => {
	...
	// Exchange logic (only used for currentAccount)
			...
			<div className="px-4 py-6 flex flex-col flex-1">
				...
				<div>
					...
					{accountId === 'currentAccount' && (
						<p className="opacity-70 text-base mb-4">{config.subtitle}</p>
					)}
					...
					{accountId === 'currentAccount' && (
						<>
							...
							<div className="mb-4">
								...
								{/* FROM Card */}
								<div className={`bg-white dark:bg-[#211E1E] rounded-lg p-4 ${hasNoFunds ? 'ring-1 ring-red-500' : ''}`}>
